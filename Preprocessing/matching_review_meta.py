...
if __name__ == "__main__":
    ...
    meta_reader = pd.read_json(data_path+"clear_review_2018.json", lines=True, chunksize=1000)
    ...
    pre_meta_df.to_json(data_path+"test_review_2018.json", orient='records', lines=True)